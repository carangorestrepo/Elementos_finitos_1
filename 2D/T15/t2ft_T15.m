function ft = t2ft_T15(xnod, LaG, nodos_ijk, carga, espesor)
...
if     isequal(nodos_ijk, LaG([1 4 5 6 2]))
    idx = [1 4 5 6 2];
elseif isequal(nodos_ijk, LaG([2 7 8 9 3]))
    idx = [2 7 8 9 3];
elseif isequal(nodos_ijk, LaG([3 10 11 12 1]))
    idx = [3 10 11 12 1];
else 
...
te = zeros(15*2,1);
te(reshape([2*idx-1; 2*idx],10,1)) = carga(:);%% son 8 por que esta asociado a los grados de libertad de la cara del elemetnto finito
...
for p = 1:n_gl
   ...
   Nijk = [ N(1) 0    N(2) 0    N(3) 0    N(4) 0    N(5) 0    N(6) 0    N(7) 0    N(8) 0    N(9) 0    N(10) 0     N(11) 0    N(12) 0    N(13) 0    N(14) 0    N(15) 0  
            0    N(1) 0    N(2) 0    N(3) 0    N(4) 0    N(5) 0    N(6) 0    N(7) 0    N(8) 0    N(9) 0     N(10)     0 N(11) 0    N(12) 0    N(13) 0    N(14) 0    N(15)];
