...
Nforma=@(xi,eta)[(3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta - 1);
                -(3*xi - 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta - 1);
                 (3*xi + 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta - 1);
                -(3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi + 1)*(eta - 1);
                 (3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((9*eta)/16 + 9/16)*(xi + 1)*(eta - 1);
                -(3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta + 1)*((9*eta)/16 + 9/16)*(xi + 1)*(eta - 1);
                 (3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi + 1)*(eta + 1);
                -(3*xi + 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta + 1);
                 (3*xi - 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta + 1);
                -(3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((3*eta)/16 + 1/16)*(xi - 1)*(eta + 1);
                 (3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta + 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1);
                -(3*xi - 1)*((3*xi)/16 + 1/16)*(3*eta - 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1);
                 (3*xi - 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1);
                -(3*xi + 1)*((9*xi)/16 + 9/16)*(3*eta - 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1);
                 (3*xi + 1)*((9*xi)/16 + 9/16)*(3*eta + 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1);
                -(3*xi - 1)*((9*xi)/16 + 9/16)*(3*eta + 1)*((9*eta)/16 + 9/16)*(xi - 1)*(eta - 1)];

%% Derivadas de N con respecto a xi
dN_dxi =@(xi,eta)[((- 27*xi^2 + 18*xi + 1)*(- 9*eta^3 + 9*eta^2 + eta - 1))/256;
                 -(9*(- 9*xi^2 + 2*xi + 3)*(- 9*eta^3 + 9*eta^2 + eta - 1))/256;
                 -(9*(9*xi^2 + 2*xi - 3)*(- 9*eta^3 + 9*eta^2 + eta - 1))/256;
                 ((27*xi^2 + 18*xi - 1)*(- 9*eta^3 + 9*eta^2 + eta - 1))/256;
                -(9*(27*xi^2 + 18*xi - 1)*(- 3*eta^3 + eta^2 + 3*eta - 1))/256;
                 (9*(27*xi^2 + 18*xi - 1)*(- 3*eta^3 - eta^2 + 3*eta + 1))/256;
                -((27*xi^2 + 18*xi - 1)*(- 9*eta^3 - 9*eta^2 + eta + 1))/256;
                 (9*(9*xi^2 + 2*xi - 3)*(- 9*eta^3 - 9*eta^2 + eta + 1))/256;
                 (9*(- 9*xi^2 + 2*xi + 3)*(- 9*eta^3 - 9*eta^2 + eta + 1))/256;
                -((- 27*xi^2 + 18*xi + 1)*(- 9*eta^3 - 9*eta^2 + eta + 1))/256;
                 (9*(- 27*xi^2 + 18*xi + 1)*(- 3*eta^3 - eta^2 + 3*eta + 1))/256;
                 -(9*(- 27*xi^2 + 18*xi + 1)*(- 3*eta^3 + eta^2 + 3*eta - 1))/256;
                 (81*(- 9*xi^2 + 2*xi + 3)*(- 3*eta^3 + eta^2 + 3*eta - 1))/256;
                 (81*(9*xi^2 + 2*xi - 3)*(- 3*eta^3 + eta^2 + 3*eta - 1))/256;
                -(81*(9*xi^2 + 2*xi - 3)*(- 3*eta^3 - eta^2 + 3*eta + 1))/256;
                -(81*(- 9*xi^2 + 2*xi + 3)*(- 3*eta^3 - eta^2 + 3*eta + 1))/256];
...
dN_deta =@(xi,eta)[((- 27*eta^2 + 18*eta + 1)*(- 9*xi^3 + 9*xi^2 + xi - 1))/256;
                 -(9*(- 27*eta^2 + 18*eta + 1)*(- 3*xi^3 + xi^2 + 3*xi - 1))/256;
                 (9*(- 27*eta^2 + 18*eta + 1)*(- 3*xi^3 - xi^2 + 3*xi + 1))/256;
                -((- 27*eta^2 + 18*eta + 1)*(- 9*xi^3 - 9*xi^2 + xi + 1))/256;
                 (9*(- 9*eta^2 + 2*eta + 3)*(- 9*xi^3 - 9*xi^2 + xi + 1))/256;
                 (9*(9*eta^2 + 2*eta - 3)*(- 9*xi^3 - 9*xi^2 + xi + 1))/256;
                -((27*eta^2 + 18*eta - 1)*(- 9*xi^3 - 9*xi^2 + xi + 1))/256;
                 (9*(27*eta^2 + 18*eta - 1)*(- 3*xi^3 - xi^2 + 3*xi + 1))/256;
                -(9*(27*eta^2 + 18*eta - 1)*(- 3*xi^3 + xi^2 + 3*xi - 1))/256;
                ...
                -(9*(9*eta^2 + 2*eta - 3)*(- 9*xi^3 + 9*xi^2 + xi - 1))/256;
                -(9*(- 9*eta^2 + 2*eta + 3)*(- 9*xi^3 + 9*xi^2 + xi - 1))/256;
                 (81*(- 9*eta^2 + 2*eta + 3)*(- 3*xi^3 + xi^2 + 3*xi - 1))/256;
                -(81*(- 9*eta^2 + 2*eta + 3)*(- 3*xi^3 - xi^2 + 3*xi + 1))/256;
                -(81*(9*eta^2 + 2*eta - 3)*(- 3*xi^3 - xi^2 + 3*xi + 1))/256;
                 (81*(9*eta^2 + 2*eta - 3)*(- 3*xi^3 + xi^2 + 3*xi - 1))/256];
...
n_gl         = 9; % orden de la cuadratura de Gauss-Legendre
...
for e = 1:nef
   ...
   for p = 1:n_gl
      for q = 1:n_gl
         ...
         N{e,p,q} = zeros(2, 2*16);
         B{e,p,q} = zeros(3, 2*16);
         for i = 1:16
...
for i = 1:nlcd
   e     = idxELEM(i);
   LaG_e = LaG(e,:);
   fte   = t2ft_Q16(xnod(LaG_e,[X Y]), LaG_e, nodoijk(i,:), carga(i,:), t(mat(e)));
...
hold on
%for e = 1:nef
%   line(xnod(LaG(e,[1:12 1]),X), xnod(LaG(e,[1:12 1]),Y), 'Color','b'); % original
%   line(xdef(LaG(e,[1:12 1]),X), xdef(LaG(e,[1:12 1]),Y), 'Color','r'); % deformada
%end
hold on
for e = 1:nef
...
A = [[    (5*15^(1/2))/18 + 10/9,         - 15^(1/2)/9 - 5/9,                      5/18,         - 15^(1/2)/9 - 5/9,     4/9,           15^(1/2)/9 - 5/9,                      5/18,           15^(1/2)/9 - 5/9,    10/9 - (5*15^(1/2))/18];
[  (5*15^(1/2))/81 + 35/162,       - 15^(1/2)/27 - 5/81,   (5*15^(1/2))/162 - 5/81,   (11*15^(1/2))/81 + 55/81,  -44/81,   55/81 - (11*15^(1/2))/81, - (5*15^(1/2))/162 - 5/81,         15^(1/2)/27 - 5/81,  35/162 - (5*15^(1/2))/81];
[ - (5*15^(1/2))/162 - 5/81,         15^(1/2)/27 - 5/81,  35/162 - (5*15^(1/2))/81,   (11*15^(1/2))/81 + 55/81,  -44/81,   55/81 - (11*15^(1/2))/81,  (5*15^(1/2))/81 + 35/162,       - 15^(1/2)/27 - 5/81,   (5*15^(1/2))/162 - 5/81];
[                      5/18,           15^(1/2)/9 - 5/9,    10/9 - (5*15^(1/2))/18,         - 15^(1/2)/9 - 5/9,     4/9,           15^(1/2)/9 - 5/9,    (5*15^(1/2))/18 + 10/9,         - 15^(1/2)/9 - 5/9,                      5/18];
[   (5*15^(1/2))/162 - 5/81,   55/81 - (11*15^(1/2))/81,  35/162 - (5*15^(1/2))/81,       - 15^(1/2)/27 - 5/81,  -44/81,         15^(1/2)/27 - 5/81,  (5*15^(1/2))/81 + 35/162,   (11*15^(1/2))/81 + 55/81, - (5*15^(1/2))/162 - 5/81];
[  35/162 - (5*15^(1/2))/81,   55/81 - (11*15^(1/2))/81,   (5*15^(1/2))/162 - 5/81,         15^(1/2)/27 - 5/81,  -44/81,       - 15^(1/2)/27 - 5/81, - (5*15^(1/2))/162 - 5/81,   (11*15^(1/2))/81 + 55/81,  (5*15^(1/2))/81 + 35/162];
[    10/9 - (5*15^(1/2))/18,           15^(1/2)/9 - 5/9,                      5/18,           15^(1/2)/9 - 5/9,     4/9,         - 15^(1/2)/9 - 5/9,                      5/18,         - 15^(1/2)/9 - 5/9,    (5*15^(1/2))/18 + 10/9];
[  35/162 - (5*15^(1/2))/81,         15^(1/2)/27 - 5/81, - (5*15^(1/2))/162 - 5/81,   55/81 - (11*15^(1/2))/81,  -44/81,   (11*15^(1/2))/81 + 55/81,   (5*15^(1/2))/162 - 5/81,       - 15^(1/2)/27 - 5/81,  (5*15^(1/2))/81 + 35/162];
[   (5*15^(1/2))/162 - 5/81,       - 15^(1/2)/27 - 5/81,  (5*15^(1/2))/81 + 35/162,   55/81 - (11*15^(1/2))/81,  -44/81,   (11*15^(1/2))/81 + 55/81,  35/162 - (5*15^(1/2))/81,         15^(1/2)/27 - 5/81, - (5*15^(1/2))/162 - 5/81];
[                      5/18,         - 15^(1/2)/9 - 5/9,    (5*15^(1/2))/18 + 10/9,           15^(1/2)/9 - 5/9,     4/9,         - 15^(1/2)/9 - 5/9,    10/9 - (5*15^(1/2))/18,           15^(1/2)/9 - 5/9,                      5/18];
[ - (5*15^(1/2))/162 - 5/81,   (11*15^(1/2))/81 + 55/81,  (5*15^(1/2))/81 + 35/162,         15^(1/2)/27 - 5/81,  -44/81,       - 15^(1/2)/27 - 5/81,  35/162 - (5*15^(1/2))/81,   55/81 - (11*15^(1/2))/81,   (5*15^(1/2))/162 - 5/81];
[  (5*15^(1/2))/81 + 35/162,   (11*15^(1/2))/81 + 55/81, - (5*15^(1/2))/162 - 5/81,       - 15^(1/2)/27 - 5/81,  -44/81,         15^(1/2)/27 - 5/81,   (5*15^(1/2))/162 - 5/81,   55/81 - (11*15^(1/2))/81,  35/162 - (5*15^(1/2))/81];
[ (5*15^(1/2))/486 + 40/729, (11*15^(1/2))/243 + 55/729,                  -55/1458, (11*15^(1/2))/243 + 55/729, 484/729, 55/729 - (11*15^(1/2))/243,                  -55/1458, 55/729 - (11*15^(1/2))/243, 40/729 - (5*15^(1/2))/486];
[                  -55/1458, 55/729 - (11*15^(1/2))/243, 40/729 - (5*15^(1/2))/486, (11*15^(1/2))/243 + 55/729, 484/729, 55/729 - (11*15^(1/2))/243, (5*15^(1/2))/486 + 40/729, (11*15^(1/2))/243 + 55/729,                  -55/1458];
[ 40/729 - (5*15^(1/2))/486, 55/729 - (11*15^(1/2))/243,                  -55/1458, 55/729 - (11*15^(1/2))/243, 484/729, (11*15^(1/2))/243 + 55/729,                  -55/1458, (11*15^(1/2))/243 + 55/729, (5*15^(1/2))/486 + 40/729];
[                  -55/1458, (11*15^(1/2))/243 + 55/729, (5*15^(1/2))/486 + 40/729, 55/729 - (11*15^(1/2))/243, 484/729, (11*15^(1/2))/243 + 55/729, 40/729 - (5*15^(1/2))/486, 55/729 - (11*15^(1/2))/243,                  -55/1458]];
    switch tipo_esf
