...
for e = 1:nef
   ...
   for p = 1:n_gl
         ...
         for i = 1:3
            ...
            N{e,p}(:,[3*i-2 3*i-1 3*i]) = [ NNforma(i)                 0  0        
                                                     0         NNforma(i) 0
                                                     0                  0 0];
...
xdef = xnod + ESC_UV*delta(:,2); % posicion de la deformada
figure
hold on
for e = 1:nef
