function ft = t2ft_Q6(xnod, LaG, nodos_ijk, carga, espesor)
...
if     isequal(nodos_ijk, LaG([1 4 3]))
    idx = [ 1 4 3 ];
elseif isequal(nodos_ijk, LaG([2 5 3]))
    idx = [ 2 5 3 ];
elseif isequal(nodos_ijk, LaG([3 6 1]))
    idx = [ 3 6 1 ];
else 
...
for p = 1:n_gl
   ...
   Nijk = [ N(1) 0    N(2) 0    N(3) 0    N(4) 0    N(5) 0    N(6) 0   
