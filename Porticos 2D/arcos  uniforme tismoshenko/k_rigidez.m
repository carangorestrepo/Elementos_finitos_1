function K=k_rigidez(xa,xb,xc,ya,yb,yc,EI,Ac)
syms x
h=yc-ya;
L=xc-xa;
...
K1=calculos_parabolico(y,dydx,EI,Ac,M,V,a,b,L,h,qa,qb,DX,DY,GM);
%K1=calculos_parabolico(y,EI,M,a,b,L,h,qa,qb,DX,DY,GM);
DX=0;
DY=1;
GM=0;
%% grado de libertad Vertical inicial
K2=calculos_parabolico(y,dydx,EI,Ac,M,V,a,b,L,h,qa,qb,DX,DY,GM);
DX=0;
DY=0;
GM=1;
%% grado de libertad giro inicial
K3=calculos_parabolico(y,dydx,EI,Ac,M,V,a,b,L,h,qa,qb,DX,DY,GM);
DX=1;
DY=0;
GM=0;
a=-L;
...
K4=calculos_parabolico(y1,dy1dx,EI,Ac,M,V,a,b,-L,h,qa,qb,DX,DY,GM);
DX=0;
DY=1;
GM=0;
%% grado de libertad Vertical final
K5=calculos_parabolico(y1,dy1dx,EI,Ac,M,V,a,b,-L,h,qa,qb,DX,DY,GM);

DX=0;
DY=0;
GM=1;
%% grado de libertad giro final
K6=calculos_parabolico(y1,dy1dx,EI,Ac,M,V,a,b,-L,h,qa,qb,DX,DY,GM);
