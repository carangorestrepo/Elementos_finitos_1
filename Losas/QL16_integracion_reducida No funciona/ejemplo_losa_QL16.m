...
hold on;
for e = 1:nef
   line(xnod(LaG(e,[1:12 1]),X), xnod(LaG(e,[1:12 1]),Y));
...
n_gl_b = 4; % orden de la cuadratura de GL para la integracion de Kb
n_gl_s = 3; % orden de la cuadratura de GL para la integracion de Ks
...
colorbar
for e = 1:nef
   fill3(xnod(LaG(e,[1:12 1]),X), ...
         xnod(LaG(e,[1:12 1]),Y), ...
         xdef(LaG(e,[1:12 1]),ww),...
         xdef(LaG(e,[1:12 1]),ww)); %deformada
end
