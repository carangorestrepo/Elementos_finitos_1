...
syms x43 x32 x21 x14 y43 y32 y21 y14 c5 c6 c7 c8 s5 s6 s7 s8 L5 L6 L7 L8 
c5 = x21/L5;      s5 = y21/L5;
c6 = x32/L6;      s6 = y32/L6;
c7 = x43/L7;      s7 = y43/L7;
c8 = x14/L8;      s8 = y14/L8;
...
% eq 40b
% dbsk = (wj - wi + Lk*(ck*bxi + sk*byi)/2 + Lk*(ck*bxj + sk*byj)/2)/(-2/3);
% eq 31%% depejando dBsk
...
% Equation 43
Adb = diag((2/3)*[ 1 1 1 1 ])

% From equation 42, we obtain equation 34
Aw = Adb*An
